...
public class MainSurat13 {
    public static void main(String[] args) {
        ...
        int menu;
        Surat13[] srtTerverif = new Surat13[10];
        int jmlVerif = 0;
        ...
        do {
            ...
            switch (menu) {
                case 1:
                    ...
                    input.nextLine();
                    Surat13 srt = new Surat13(idSurat, namaMahasiswa, kelas, jenisIzin, durasi);
                    stack.push(srt);
                    System.out.printf("Surat %s berhasil dikumpulkan\n", srt.namaMahasiswa);
                    break;

                case 2:
                    Surat13 dicek = stack.pop();
                    if (dicek != null) {
                        System.out.println();
                ...
                case 4:
                    ...
                    if (find) {
                        if (posisi >= 0 && posisi < stack.size && stack.stack[posisi] != null) {
                            Surat13 suratDitemukan = stack.stack[posisi];
                            System.out.println("\nSurat Ditemukan : ");
                            ...
                            Surat13 suratDitemukan = srtTerverif[posisi];
                            System.out.println("\nSurat Ditemukan : ");
                            System.out.println("ID Surat : " + suratDitemukan.idSurat);
                            System.out.println("Nama Mahasiswa : " + suratDitemukan.namaMahasiswa);
                            System.out.println("Kelas : " + suratDitemukan.kelas);
